  ...
  const projects = [
    {
      ...
      description:
        "AI-based resume screening system that matches resumes with job descriptions using RAG technology. Provides percentage match analysis and missing keywords identification for recruiters.",
      imgSrc: mursImg,
      liveLink: "#",
    ...
    },
    {
      ...
      description:
        "Interactive portfolio chatbot powered by OpenRouter API that answers questions based on CV/Resume content. Features real-time responses and context-aware conversations.",
      imgSrc: ethixImg,
      liveLink: "#",
    ...
    <>
      <div className="pt-[96px] max-sm:pt-[40px] bg-white">
        <div className="custom-container mx-auto max-w-[1440px] px-[20px]">
          ...
          {/* Projects Grid - 3 cards in a row, 4th card centered below */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* First 3 projects - normal grid */}
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      >
                        <svg className="w-5 h-5 text-gray-700 hover:text-black transition-colors" fill="currentColor" viewBox="0 0 24 24">
                          <path fillRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.03-2.682-.103-.253-.447-1.27.098-2.646 0 0 .84-.269 2.75 1.025.8-.223 1.65-.334 2.5-.334.85 0 1.7.111 2.5.334 1.91-1.294 2.75-1.025 2.75-1.025.545 1.376.201 2.393.099 2.646.64.698 1.03 1.591 1.03 2.682 0 3.841-2.337 4.687-4.565 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.161 22 16.418 22 12c0-5.523-4.477-10-10-10z" clipRule="evenodd" />
                        </svg>
                      </a>
                    </div>
                  </div>
